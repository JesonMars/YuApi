...
public interface UserLocationMapper {
     ...
     */
    @Insert("INSERT INTO user_locations (id, user_id, name, address, longitude, latitude, type, create_time) " +
            "VALUES (#{id}, #{userId}, #{name}, #{address}, #{longitude}, #{latitude}, #{type}, NOW())")
