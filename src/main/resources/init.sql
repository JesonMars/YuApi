...
-- 插入城市数据
INSERT INTO cities (city_name, city_code, province, adcode, center_lng, center_lat, status, sort_order) VALUES
-- 直辖市
('北京市', 'bj', '北京', '110000', 116.405285, 39.904989, 1, 1),
('天津市', 'tj', '天津', '120000', 117.190182, 39.125596, 1, 2),
('上海市', 'sh', '上海', '310000', 121.472644, 31.231706, 1, 3),
('重庆市', 'cq', '重庆', '500000', 106.504962, 29.533155, 1, 4),
-- 广东省
('广州市', 'gz', '广东省', '440100', 113.280637, 23.125178, 1, 5),
('深圳市', 'sz', '广东省', '440300', 114.085947, 22.547, 1, 6),
('杭州市', 'hangzhou', '浙江省', '330100', 120.153576, 30.287459, 1, 7),
('宁波市', 'nb', '浙江省', '330200', 121.549792, 29.868388, 1, 8),
('温州市', 'wz', '浙江省', '330300', 120.672111, 28.000575, 1, 9),
('东莞市', 'dg', '广东省', '441900', 113.746262, 23.046237, 1, 10),
('佛山市', 'fs', '广东省', '440600', 113.122717, 23.028762, 1, 11),
('惠州市', 'hz', '广东省', '441300', 114.412599, 23.079404, 1, 12),
('中山市', 'zs', '广东省', '442000', 113.382391, 22.521113, 1, 13),
('珠海市', 'zh', '广东省', '440400', 113.553986, 22.224979, 1, 14),
('南京市', 'nj', '江苏省', '320100', 118.767413, 32.041544, 1, 15),
('苏州市', 'suzhou', '江苏省', '320500', 120.619585, 31.299379, 1, 16),
('无锡市', 'wx', '江苏省', '320200', 120.301663, 31.574729, 1, 17),
('常州市', 'cz', '江苏省', '320400', 119.946973, 31.772752, 1, 18),
('济南市', 'jinan', '山东省', '370100', 117.000923, 36.675807, 1, 19),
('青岛市', 'qingdao', '山东省', '370200', 120.355173, 36.082982, 1, 20),
-- 河北省
('石家庄市', 'sjz', '河北省', '130100', 114.502461, 38.045474, 1, 21),
('唐山市', 'ts', '河北省', '130200', 118.175393, 39.635113, 1, 22),
('保定市', 'bd', '河北省', '130600', 115.482331, 38.867657, 1, 23),
('廊坊市', 'lf', '河北省', '131000', 116.7, 39.529, 1, 24),
-- 江苏省续
('镇江市', 'zj', '江苏省', '321100', 119.452753, 32.204402, 1, 25),
('南通市', 'nt', '江苏省', '320600', 120.864608, 32.016212, 1, 26),
('泰州市', 'taizhou_js', '江苏省', '321200', 119.915176, 32.484882, 1, 27),
('扬州市', 'yz', '江苏省', '321000', 119.421003, 32.393159, 1, 28),
('徐州市', 'xuzhou', '江苏省', '320300', 117.184811, 34.261792, 1, 29),
-- 浙江省续
('嘉兴市', 'jx', '浙江省', '330400', 120.750865, 30.762653, 1, 30),
('湖州市', 'huzhou', '浙江省', '330500', 120.102398, 30.867198, 1, 31),
('绍兴市', 'sx', '浙江省', '330600', 120.582112, 29.997117, 1, 32),
('金华市', 'jh', '浙江省', '330700', 119.649506, 29.089524, 1, 33),
('台州市', 'taizhou_zj', '浙江省', '331000', 121.428599, 28.661378, 1, 34),
-- 山东省续
('烟台市', 'yt', '山东省', '370600', 121.391382, 37.539297, 1, 35),
('潍坊市', 'wf', '山东省', '370700', 119.107078, 36.70925, 1, 36),
('淄博市', 'zb', '山东省', '370300', 118.047648, 36.814939, 1, 37),
('威海市', 'wh', '山东省', '371000', 122.116394, 37.509691, 1, 38),
('临沂市', 'ly', '山东省', '371300', 118.326443, 35.065282, 1, 39),
-- 其他重要城市
('成都市', 'cd', '四川省', '510100', 104.065735, 30.659462, 1, 40),
('武汉市', 'wuhan', '湖北省', '420100', 114.298572, 30.584355, 1, 41),
('西安市', 'xa', '陕西省', '610100', 108.948024, 34.263161, 1, 42),
('郑州市', 'zz', '河南省', '410100', 113.665412, 34.757975, 1, 43),
('长沙市', 'cs', '湖南省', '430100', 112.982279, 28.19409, 1, 44),
('昆明市', 'km', '云南省', '530100', 102.712251, 25.040609, 1, 45),
('南宁市', 'nn', '广西壮族自治区', '450100', 108.320004, 22.82402, 1, 46),
('福州市', 'fz', '福建省', '350100', 119.306239, 26.075302, 1, 47),
